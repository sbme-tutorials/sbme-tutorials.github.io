...
# decktape --chrome-arg=--allow-file-access-from-files \
# -s 1024x768 http://127.0.0.1:4000/2020/cv/presentations/week06_templates.html week06_templates.pdf


decktape --chrome-arg=--allow-file-access-from-files \
-s 1024x768 http://127.0.0.1:4000/2020/cv/presentations/week06_sift.html week06_sift.pdf
