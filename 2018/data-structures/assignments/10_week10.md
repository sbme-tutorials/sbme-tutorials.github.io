...
1. setting some first-class-citezen variable to declare our usage of the modern C++11 standard. The `set` takes to parameters seperated by a space. The first parameter is the variable name, while the second parameter is the value of that variable.
